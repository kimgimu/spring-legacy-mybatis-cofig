...
public class UserDTO {
	...
	public UserDTO(String memberId, String memberPwd, String memberName, String memberEnrollDt) {
		super();
	...
	public String toString() {
		return "UserDTO [memberId=" + memberId + ", memberPwd=" + memberPwd + ", memberName=" + memberName
